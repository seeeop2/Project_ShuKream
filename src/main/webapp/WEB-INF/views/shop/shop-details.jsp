            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tabs-5" role="tabpanel">
                <div class="product__details__tab__content">
                  <p class="note">ShuKream은 최대한 빠르게 모든 상품을 배송하기 위해 노력하고 있습니다. <br>
                                          배송 시간은 판매자가 검수를 위하여 상품을 검수센터로 보내는 속도에 따라 차이가 있습니다.
                  </p>
                  <div class="product__details__tab__content__item">
                    <h5> 일반 구매 </h5>
                    <p>- 거래가 체결된 시점부터 48시간(일요일•공휴일 제외) 내에 판매자가 상품을 발송해야 하며, 통상적으로 발송 후 1-2일 내에 ShuKream 검수센터에 도착합니다.</p>
              ...
              <div class="tab-pane" id="tabs-6" role="tabpanel">
                <div class="product__details__tab__content">
                  ...
                  <div class="product__details__tab__content__item">
                    ...
                    <p>* 검수 합격: ShuKream 검수택(Tag)이 부착되어 배송을 준비함</p>
              ...
              <div class="tab-pane" id="tabs-7" role="tabpanel">
                <div class="product__details__tab__content">
                  <p class="note">ShuKream은 익명 거래를 기반으로 판매자가 판매하는 상품을 구매자가 실시간으로 구매하여 거래를 체결합니다.</p>
                  <div class="product__details__tab__content__item">
                    <h5>Infomation</h5>
                    <p>- 단순 변심이나 실수에 의한 취소/교환/반품이 불가능합니다. 상품을 원하지 않으시는 경우 언제든지 ShuKream에서 재판매를 하실 수 있습니다.</p>
                    <p>- 상품 수령 후, 이상이 있는 경우 ShuKream 고객센터로 문의해주시기 바랍니다.</p>
                  </div>
                </div>
              </div>
            </div>
