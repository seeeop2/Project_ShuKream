...
public class Pagination {
	...
	private final int BLOCK_SIZE = 3; // 페이지 네이션 블록의 크기
	...
	//만약 한페이지에 3개씩 보여주는 경우 현재페이지 번호가 2번일때 2-1 => 1 * 3+1 => 4번부터 보여줌
...
//	}
	...
	// startPage는 4가됐을것이고 + 3 - 1 을통해 endPage가 6이됨
	//그래서 4 5 6 으로 페이지 번호가 나타난다
